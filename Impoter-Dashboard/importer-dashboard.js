...
(function () {
    ...
    function activateSection(target, options = {}) {
        ...
        // Load forward contracts when payments tab is activated
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function generateImporterPDF(data) {
        ...
        if (importerAuth && importerDatabase && importerAuth.currentUser) {
            ...
            try {
                await importerDatabase.ref(`importers/${user.uid}/forwardContracts/${contractId}`).set(contractData);
    ...
    async function loadImporterForwardContractsInPayments() {
        ...
        try {
            ...
            const contractsRef = importerDatabase.ref(`importers/${user.uid}/forwardContracts`);
    ...
    async function downloadImporterForwardContractPDF(contractId) {
        ...
        try {
            const contractRef = importerDatabase.ref(`importers/${user.uid}/forwardContracts/${contractId}`);
